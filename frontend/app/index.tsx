...
const FreeGenerateScreen: React.FC<{
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      {/* Bottom Tab Navigation - Should be visible at bottom */}
      <View style={[styles.tabBarContainer, { backgroundColor: 'red' }]}> {/* RED to make visible */}
        <TouchableOpacity 
        ...
        >
          ...
          <Text style={[
            styles.tabLabel, 
            { color: '#666' },
            activeTab === 'generate' && { color: '#007AFF' }
          ]}>
            Generate
          </Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={[
            styles.tabLabel, 
            { color: '#666' },
            activeTab === 'gallery' && { color: '#007AFF' }
          ]}>
            Gallery
          </Text>
        </TouchableOpacity>
...
function App() {
  ...
  const [appState, setAppState] = useState('welcome'); // Back to welcome for normal flow
